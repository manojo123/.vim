...
call s:create_palette_color('darkgreen',   { 'gui': '#00af5f', 'cterm': '35' })
...
call s:h('SublimeLightBlack',  { 'fg': s:black   })
call s:h('SublimeLightBlack2', { 'fg': s:black  })
call s:h('SublimeDarkBlack',   { 'fg': s:black    })
...
call s:h('SublimeDarkGreen',   { 'fg': s:darkgreen    })
...
hi! link NERDTreeHelp            SublimeGrey
hi! link NERDTreeOpenable        SublimeYellow
hi! link NERDTreeUp              SublimeWhite
hi! link NERDTreeExecFile        SublimeWhite
...
call s:h("phpFunction", { "fg": s:green })
call s:h("phpFunctions", { "fg": s:aqua })
call s:h("phpUseAlias", { "fg": s:green })
call s:h("phpUseClass", { "fg": s:aqua })
call s:h("phpKeyword", { "fg": s:pink })
call s:h("phpKeywordSpecial", { "fg": s:aqua })
call s:h("phpInclude", { "fg": s:pink })
call s:h("phpType", { "fg": s:pink })
call s:h("phpMethod", { "fg": s:darkgreen })
call s:h("phpParameters", { "fg": s:orange })
